...
#SELECT countries.id, countries.name, countries.government_form FROM countries
...
#SELECT countries.name, cities.name, cities.country_id, cities.population, cities.district FROM countries
#JOIN cities on countries.id = cities.country_id
